    ...
    <div className="bg-white dark:bg-black dark:text-yellow-300">
      <div>
        ...
        <div className="px-10 py-5">
          <div>
            <h1 className="font-bold text-2xl opacity-85">Tahasil</h1>
          </div>
        </div>
      </div>
            ...
            <table className="border-collapse border w-full ">
              <thead className="bg-[#245e03] text-white ">
                <tr>
                  ...
                  <td className="border border-gray-400 p-3">Tahasil Naame</td>
                  <td className="border border-gray-400 p-3">
                    Number Of RI Circles
                  </td>
                  <td className="border border-gray-400 p-3">No of Villages</td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="border border-gray-400 p-3">201</td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="border border-gray-400 p-3">416</td>
                </tr>
