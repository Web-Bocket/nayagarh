    ...
    <div className="bg-white dark:bg-black dark:text-yellow-300">
      <div>
        ...
        <div className="px-10 py-5">
          <div>
            <h1 className="font-bold text-2xl opacity-85">Telephone Directory</h1>
          </div>
        </div>
      </div>
      ...
      <div className=" px-10 flex gap-8 py-5">
        ...
        <div>
            <table>
                <caption className="text-left">Phone Number of Offices of the District</caption>
                <thead>
                    <tr>
                        <th className="bg-green-800 text-white p-2 text-left border-2">Sl.NO</th>
                        <th className="bg-green-800 text-white p-2 text-left border-2">District</th>
                        <th className="bg-green-800 text-white p-2 text-left border-2">Office</th>
                        <th className="bg-green-800 text-white p-2 text-left border-2">Designation</th>
                        <th className="bg-green-800 text-white p-2 text-left border-2">Phone No.</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td className="p-2 border-2">Office Of the Chief District Veterinary Officer</td>
                        <td className="p-2 border-2">Chief District Veterinary Officer</td>
                        <td className="p-2 border-2">06753-252338</td>
                    </tr>
                    <tr>
                        <td className="p-2 border-2">2</td>
                        <td className="p-2 border-2">Nayagarh</td>
                        <td className="p-2 border-2">Rural Water Supply And Sanitation</td>
                    ...
                    <tr>
                        ...
                        <td className="p-2 border-2">Nayagarh</td>
                        <td className="p-2 border-2">Executive Engineer Rural Works Division</td>
                    ...
                    <tr>
                        ...
                        <td className="p-2 border-2">Nayagarh</td>
                        <td className="p-2 border-2">General Manager District Industries Centre</td>
                    ...
                    <tr>
                        ...
                        <td className="p-2 border-2">District Social Welfare Officer</td>
                        <td className="p-2 border-2">06753-253433</td>
                    </tr>
                    <tr>
                        <td className="p-2 border-2">7</td>
                        <td className="p-2 border-2">Nayagarh</td>
                        <td className="p-2 border-2">Superintendent of Police office</td>
                    ...
                    <tr>
                        ...
                        <td className="p-2 border-2">DIPRO cum Dist. Culture Officer</td>
                        <td className="p-2 border-2">06753-253051</td>
                    </tr>
                    <tr>
                        <td className="p-2 border-2">9</td>
                        <td className="p-2 border-2">Nayagarh</td>
                        <td className="p-2 border-2">District Information and Public Relation Office</td>
                        <td className="p-2 border-2">DIPRO cum Dist. Culture Officer</td>
                        <td className="p-2 border-2">06753-253051</td>
                    </tr>
                    <tr>
